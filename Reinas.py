...
PROBLEMAS DE LAS 8 REYNAS

Cruz Pérez Raúl Eduardo
Morales Sánchez Eder Isai
Pimentel Escobedo Luis Carlos
'''
...
def main():
    ...
    stats.register("Desviación Estándar", numpy.std)
